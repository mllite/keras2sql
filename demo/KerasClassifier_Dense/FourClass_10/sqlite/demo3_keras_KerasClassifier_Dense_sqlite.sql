...
(SELECT layer_dense_2_1."KEY" AS "KEY", layer_dense_2_1.output_1 AS "Score_0", exp(min(100.0, max(-100.0, layer_dense_2_1.output_1))) AS "exp_Score_0", layer_dense_2_1.output_2 AS "Score_1", exp(min(100.0, max(-100.0, layer_dense_2_1.output_2))) AS "exp_Score_1", layer_dense_2_1.output_3 AS "Score_2", exp(min(100.0, max(-100.0, layer_dense_2_1.output_3))) AS "exp_Score_2", layer_dense_2_1.output_4 AS "Score_3", exp(min(100.0, max(-100.0, layer_dense_2_1.output_4))) AS "exp_Score_3" 
