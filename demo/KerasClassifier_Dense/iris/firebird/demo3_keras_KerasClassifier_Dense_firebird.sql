...
(SELECT layer_dense_2_1."KEY" AS "KEY", layer_dense_2_1.output_1 AS "Score_0", exp(CASE WHEN (minvalue(100.0, maxvalue(-100.0, layer_dense_2_1.output_1)) >= -709.782712893384) THEN minvalue(100.0, maxvalue(-100.0, layer_dense_2_1.output_1)) ELSE -709.782712893384 END) AS "exp_Score_0", layer_dense_2_1.output_2 AS "Score_1", exp(CASE WHEN (minvalue(100.0, maxvalue(-100.0, layer_dense_2_1.output_2)) >= -709.782712893384) THEN minvalue(100.0, maxvalue(-100.0, layer_dense_2_1.output_2)) ELSE -709.782712893384 END) AS "exp_Score_1", layer_dense_2_1.output_3 AS "Score_2", exp(CASE WHEN (minvalue(100.0, maxvalue(-100.0, layer_dense_2_1.output_3)) >= -709.782712893384) THEN minvalue(100.0, maxvalue(-100.0, layer_dense_2_1.output_3)) ELSE -709.782712893384 END) AS "exp_Score_2" 
