...
FROM keras_input), 
layer_dense_1 AS 
(SELECT keras_input_1."KEY" AS "KEY", 0.0 + -0.11281444952672026 * keras_input_1."Feature_0" + -0.6290437167939718 * keras_input_1."Feature_1" + -0.68533367483761 * keras_input_1."Feature_2" + 0.09062090724345317 * keras_input_1."Feature_3" AS output_1, -0.43897317836840916 + 0.2311617084325953 * keras_input_1."Feature_0" + -0.0686736376780214 * keras_input_1."Feature_1" + -0.10945067096837464 * keras_input_1."Feature_2" + 0.5378567204889299 * keras_input_1."Feature_3" AS output_2, 0.0 + -0.5357525615511114 * keras_input_1."Feature_0" + 0.4315035234678404 * keras_input_1."Feature_1" + -0.7939947958188902 * keras_input_1."Feature_2" + -0.8410838228616502 * keras_input_1."Feature_3" AS output_3, 0.0 + -0.32287987074367663 * keras_input_1."Feature_0" + -0.11664781485514286 * keras_input_1."Feature_1" + -0.30826797999578026 * keras_input_1."Feature_2" + -0.3120039953711615 * keras_input_1."Feature_3" AS output_4 
FROM keras_input_1), 
activation_relu AS 
...
layer_dense_2 AS 
(SELECT activation_relu_1_1."KEY" AS "KEY", 0.2636804705078169 + 0.6305062762098601 * activation_relu_1_1.output_1 + -0.3585050786223678 * activation_relu_1_1.output_2 + 0.5741738380977317 * activation_relu_1_1.output_3 + 0.07926929534297522 * activation_relu_1_1.output_4 AS output_1, 0.22823185554454842 + -0.7566051101956481 * activation_relu_1_1.output_1 + -0.13546549302115693 * activation_relu_1_1.output_2 + 0.60860151581279 * activation_relu_1_1.output_3 + -0.6083992426049094 * activation_relu_1_1.output_4 AS output_2, -0.37239300543420456 + -0.5296362740553289 * activation_relu_1_1.output_1 + 0.5671583278012485 * activation_relu_1_1.output_2 + 0.5610256732633128 * activation_relu_1_1.output_3 + 0.8782704380577033 * activation_relu_1_1.output_4 AS output_3 
