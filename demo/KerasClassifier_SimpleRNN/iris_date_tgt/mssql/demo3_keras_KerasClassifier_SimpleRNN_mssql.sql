...
FROM score_soft_max), 
orig_cte AS 
(SELECT layer_softmax.[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_1789-07-14T00:00:00.000000000], CAST(NULL AS FLOAT(53)) AS [Score_1789-08-14T00:00:00.000000000], CAST(NULL AS FLOAT(53)) AS [Score_1789-09-14T00:00:00.000000000], layer_softmax.output_1 AS [Proba_1789-07-14T00:00:00.000000000], layer_softmax.output_2 AS [Proba_1789-08-14T00:00:00.000000000], layer_softmax.output_3 AS [Proba_1789-09-14T00:00:00.000000000], CAST(NULL AS FLOAT(53)) AS [LogProba_1789-07-14T00:00:00.000000000], CAST(NULL AS FLOAT(53)) AS [LogProba_1789-08-14T00:00:00.000000000], CAST(NULL AS FLOAT(53)) AS [LogProba_1789-09-14T00:00:00.000000000], CAST(NULL AS BIGINT) AS [Decision], CAST(NULL AS FLOAT(53)) AS [DecisionProba] 
FROM layer_softmax), 
