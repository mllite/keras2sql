...
(SELECT keras_input_1_rn.rn AS rn, keras_input_1_rn."KEY" AS "KEY", keras_input_1_rn."Feature_0" AS "Feature_0", keras_input_1_rn."Feature_1" AS "Feature_1", keras_input_1_rn."Feature_2" AS "Feature_2", keras_input_1_rn."Feature_3" AS "Feature_3", 0.0879253000581003 + -0.07322252198320371 * keras_input_1_rn."Feature_0" + 0.44066170421393824 * keras_input_1_rn."Feature_1" + 0.0097895047441887 * keras_input_1_rn."Feature_2" + 0.03478267270182941 * keras_input_1_rn."Feature_3" AS dot_prod_z_1, 0.0 + 0.5664769474564575 * keras_input_1_rn."Feature_0" + -0.10433297737716374 * keras_input_1_rn."Feature_1" + 0.6144268301148657 * keras_input_1_rn."Feature_2" + 0.7653194061893915 * keras_input_1_rn."Feature_3" AS dot_prod_z_2, 0.0 + -0.4791916586991701 * keras_input_1_rn."Feature_0" + -0.6129810736826532 * keras_input_1_rn."Feature_1" + -0.7522882410776167 * keras_input_1_rn."Feature_2" + -0.6622454570567866 * keras_input_1_rn."Feature_3" AS dot_prod_r_1, 0.0 + -0.28879253581968267 * keras_input_1_rn."Feature_0" + 0.12763855553755143 * keras_input_1_rn."Feature_1" + -0.2790648571605788 * keras_input_1_rn."Feature_2" + -0.3966151216257316 * keras_input_1_rn."Feature_3" AS dot_prod_r_2, 0.5183235820029343 + -0.12200430396588713 * keras_input_1_rn."Feature_0" + -0.22034300960444347 * keras_input_1_rn."Feature_1" + -0.12376404852047486 * keras_input_1_rn."Feature_2" + 0.31202602724403444 * keras_input_1_rn."Feature_3" AS dot_prod_h_1, 0.0 + 0.3335265374845531 * keras_input_1_rn."Feature_0" + -0.27572326342284403 * keras_input_1_rn."Feature_1" + 0.19965769124877464 * keras_input_1_rn."Feature_2" + -0.20665982842609176 * keras_input_1_rn."Feature_3" AS dot_prod_h_2 
FROM keras_input_1_rn), 
rnn_cte_gru_1(rn_1, "KEY", "PreviousState_1", "PreviousState_2", "State_1", "State_2") AS 
(SELECT gru_input_kernel_bias.rn AS rn_1, gru_input_kernel_bias."KEY" AS "KEY", CAST(0.0 AS DOUBLE PRECISION) AS "PreviousState_1", CAST(0.0 AS DOUBLE PRECISION) AS "PreviousState_2", (1.0 - maxvalue(0.0, minvalue(1.0, 0.2 * (0.0 + gru_input_kernel_bias.dot_prod_z_1) + 0.5))) * tanh(0.0 + gru_input_kernel_bias.dot_prod_h_1) AS "State_1", (1.0 - maxvalue(0.0, minvalue(1.0, 0.2 * (0.0 + gru_input_kernel_bias.dot_prod_z_2) + 0.5))) * tanh(0.0 + gru_input_kernel_bias.dot_prod_h_2) AS "State_2" 
FROM gru_input_kernel_bias 
WHERE gru_input_kernel_bias.rn = 1 UNION ALL SELECT gru_input_kernel_bias.rn AS rn, gru_input_kernel_bias."KEY" AS "KEY", CAST(0.0 AS DOUBLE PRECISION) AS "PreviousState_1", CAST(0.0 AS DOUBLE PRECISION) AS "PreviousState_2", maxvalue(0.0, minvalue(1.0, 0.2 * (0.07889305402131672 * CAST(0.0 AS DOUBLE PRECISION) + -0.12001338771399168 * CAST(0.0 AS DOUBLE PRECISION) + gru_input_kernel_bias.dot_prod_z_1) + 0.5)) * CAST(0.0 AS DOUBLE PRECISION) + (1.0 - maxvalue(0.0, minvalue(1.0, 0.2 * (0.07889305402131672 * CAST(0.0 AS DOUBLE PRECISION) + -0.12001338771399168 * CAST(0.0 AS DOUBLE PRECISION) + gru_input_kernel_bias.dot_prod_z_1) + 0.5))) * tanh(0.19308494093258327 * maxvalue(0.0, minvalue(1.0, 0.2 * (-0.1888178280225422 * CAST(0.0 AS DOUBLE PRECISION) + -0.24466095906319685 * CAST(0.0 AS DOUBLE PRECISION) + gru_input_kernel_bias.dot_prod_r_1) + 0.5)) * CAST(0.0 AS DOUBLE PRECISION) + 0.7665848473643189 * maxvalue(0.0, minvalue(1.0, 0.2 * (-0.5245068706087566 * CAST(0.0 AS DOUBLE PRECISION) + -0.3341770861035541 * CAST(0.0 AS DOUBLE PRECISION) + gru_input_kernel_bias.dot_prod_r_2) + 0.5)) * CAST(0.0 AS DOUBLE PRECISION) + gru_input_kernel_bias.dot_prod_h_1) AS "State_1", maxvalue(0.0, minvalue(1.0, 0.2 * (-0.034960511057912716 * CAST(0.0 AS DOUBLE PRECISION) + -0.14062053889322335 * CAST(0.0 AS DOUBLE PRECISION) + gru_input_kernel_bias.dot_prod_z_2) + 0.5)) * CAST(0.0 AS DOUBLE PRECISION) + (1.0 - maxvalue(0.0, minvalue(1.0, 0.2 * (-0.034960511057912716 * CAST(0.0 AS DOUBLE PRECISION) + -0.14062053889322335 * CAST(0.0 AS DOUBLE PRECISION) + gru_input_kernel_bias.dot_prod_z_2) + 0.5))) * tanh(0.8028151871906004 * maxvalue(0.0, minvalue(1.0, 0.2 * (-0.1888178280225422 * CAST(0.0 AS DOUBLE PRECISION) + -0.24466095906319685 * CAST(0.0 AS DOUBLE PRECISION) + gru_input_kernel_bias.dot_prod_r_1) + 0.5)) * CAST(0.0 AS DOUBLE PRECISION) + -0.4545734405306024 * maxvalue(0.0, minvalue(1.0, 0.2 * (-0.5245068706087566 * CAST(0.0 AS DOUBLE PRECISION) + -0.3341770861035541 * CAST(0.0 AS DOUBLE PRECISION) + gru_input_kernel_bias.dot_prod_r_2) + 0.5)) * CAST(0.0 AS DOUBLE PRECISION) + gru_input_kernel_bias.dot_prod_h_2) AS "State_2" 
FROM gru_input_kernel_bias, rnn_cte_gru_1 
WHERE gru_input_kernel_bias.rn = rnn_cte_gru_1.rn_1 + 1), 
gru_1 AS 
(SELECT rnn_cte_gru_1."KEY" AS "KEY", CAST(rnn_cte_gru_1."State_1" AS DOUBLE PRECISION) AS output_1, CAST(rnn_cte_gru_1."State_2" AS DOUBLE PRECISION) AS output_2 
FROM rnn_cte_gru_1), 
gru_1_1 AS 
(SELECT gru_1."KEY" AS "KEY", gru_1.output_1 AS output_1, gru_1.output_2 AS output_2 
FROM gru_1), 
layer_dense_1 AS 
(SELECT gru_1_1."KEY" AS "KEY", -0.05479406807683336 + 0.14968294480807742 * gru_1_1.output_1 + -0.28988967716910585 * gru_1_1.output_2 AS output_1, 0.10674915365250251 + 0.8377346545450602 * gru_1_1.output_1 + -0.27976115144718106 * gru_1_1.output_2 AS output_2, -0.05996302304744201 + -0.5804704741095879 * gru_1_1.output_1 + -0.941305778610394 * gru_1_1.output_2 AS output_3 
FROM gru_1_1), 
layer_dense_1_1 AS 
...
FROM score_soft_max), 
orig_cte AS 
(SELECT layer_softmax."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_1789-07-14T00:00:00.000000000", CAST(NULL AS DOUBLE PRECISION) AS "Score_1789-08-14T00:00:00.000000000", CAST(NULL AS DOUBLE PRECISION) AS "Score_1789-09-14T00:00:00.000000000", layer_softmax.output_1 AS "Proba_1789-07-14T00:00:00.000000000", layer_softmax.output_2 AS "Proba_1789-08-14T00:00:00.000000000", layer_softmax.output_3 AS "Proba_1789-09-14T00:00:00.000000000", CAST(NULL AS DOUBLE PRECISION) AS "LogProba_1789-07-14T00:00:00.000000000", CAST(NULL AS DOUBLE PRECISION) AS "LogProba_1789-08-14T00:00:00.000000000", CAST(NULL AS DOUBLE PRECISION) AS "LogProba_1789-09-14T00:00:00.000000000", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS DOUBLE PRECISION) AS "DecisionProba" 
FROM layer_softmax), 
