...
WHERE gru_input_kernel_bias.rn = 1 UNION ALL SELECT gru_input_kernel_bias.rn AS rn, gru_input_kernel_bias."KEY" AS "KEY", CAST(0.0 AS BINARY_DOUBLE) AS "PreviousState_1", CAST(0.0 AS BINARY_DOUBLE) AS "PreviousState_2", greatest(0.0, least(1.0, 0.2 * (0.07889305402131672 * CAST(0.0 AS BINARY_DOUBLE) + -0.12001338771399168 * CAST(0.0 AS BINARY_DOUBLE) + gru_input_kernel_bias.dot_prod_z_1) + 0.5)) * CAST(0.0 AS BINARY_DOUBLE) + (1.0 - greatest(0.0, least(1.0, 0.2 * (0.07889305402131672 * CAST(0.0 AS BINARY_DOUBLE) + -0.12001338771399168 * CAST(0.0 AS BINARY_DOUBLE) + gru_input_kernel_bias.dot_prod_z_1) + 0.5))) * tanh(0.19308494093258327 * greatest(0.0, least(1.0, 0.2 * (-0.1888178280225422 * CAST(0.0 AS BINARY_DOUBLE) + -0.24466095906319685 * CAST(0.0 AS BINARY_DOUBLE) + gru_input_kernel_bias.dot_prod_r_1) + 0.5)) * CAST(0.0 AS BINARY_DOUBLE) + 0.7665848473643189 * greatest(0.0, least(1.0, 0.2 * (-0.5245068706087566 * CAST(0.0 AS BINARY_DOUBLE) + -0.3341770861035541 * CAST(0.0 AS BINARY_DOUBLE) + gru_input_kernel_bias.dot_prod_r_2) + 0.5)) * CAST(0.0 AS BINARY_DOUBLE) + gru_input_kernel_bias.dot_prod_h_1) AS "State_1", greatest(0.0, least(1.0, 0.2 * (-0.034960511057912716 * CAST(0.0 AS BINARY_DOUBLE) + -0.14062053889322335 * CAST(0.0 AS BINARY_DOUBLE) + gru_input_kernel_bias.dot_prod_z_2) + 0.5)) * CAST(0.0 AS BINARY_DOUBLE) + (1.0 - greatest(0.0, least(1.0, 0.2 * (-0.034960511057912716 * CAST(0.0 AS BINARY_DOUBLE) + -0.14062053889322335 * CAST(0.0 AS BINARY_DOUBLE) + gru_input_kernel_bias.dot_prod_z_2) + 0.5))) * tanh(0.8028151871906004 * greatest(0.0, least(1.0, 0.2 * (-0.1888178280225422 * CAST(0.0 AS BINARY_DOUBLE) + -0.24466095906319685 * CAST(0.0 AS BINARY_DOUBLE) + gru_input_kernel_bias.dot_prod_r_1) + 0.5)) * CAST(0.0 AS BINARY_DOUBLE) + -0.4545734405306024 * greatest(0.0, least(1.0, 0.2 * (-0.5245068706087566 * CAST(0.0 AS BINARY_DOUBLE) + -0.3341770861035541 * CAST(0.0 AS BINARY_DOUBLE) + gru_input_kernel_bias.dot_prod_r_2) + 0.5)) * CAST(0.0 AS BINARY_DOUBLE) + gru_input_kernel_bias.dot_prod_h_2) AS "State_2" 
